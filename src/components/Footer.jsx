...
const Footer = () => {
  // Constante pour l'icône de la flèche
  ...
  const toggleVisibility = () => {
    ...
    setIsVisible(window.scrollY > 10); // Affiche la flèche après 300 pixels de défilement
  };
  ...
  return (
    <footer>
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <ul className="customBullets">
              <li>
                {arrowIcon}
                <a href="/realisations">Fresh food</a>
              </li>
              <li>
                {arrowIcon}
                <a href="/realisations">Restaurant Akira</a>
              </li>
              <li>
                {arrowIcon}
                <a href="/realisations">Espace bien-être</a>
              </li>
          ...
          <div className="col-md-3">
            ...
            <ul className="customBullets">
              ...
              <li>
                {arrowIcon}
                <a href="/blog">Vendre ses produit sur le web</a>
              </li>
              <li>
                {arrowIcon}
      ...
      {/* Ligne de copyright */}
      <div className="copyright text-center py-3 border border-dark bg-black text-light">
