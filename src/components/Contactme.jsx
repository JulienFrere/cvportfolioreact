            ...
            <div className="row mt-5">
              ...
              <div className="col-md-6">
                ...
                <p className="info-text mt-5">
                  <i className="fas fa-map-marker-alt"></i> 40 Rue Laure Diebold, 69009 Lyon, France
                </p>
                <p className="info-text">
                  <i className="fas fa-phone-alt"></i> 06 20 30 40 50
                </p>
                <iframe className="map-iframe" src="https://www.google.com/maps/embed?pb=..." allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>
              </div>
            </div>
          </div>
        </div>
