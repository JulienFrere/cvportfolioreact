...
import officeWork from '../assets/img/office-work.png';
                ...
                <div className="card-body p-4 m-4">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            j'ai pu acquérir des bases solides pour travailler dans le domaine du <strong>développement web.</strong><br/>
                            Basé à Lyon, je suis en recherche d'alternance au sein d'une agence digitale pour consolider ma formation de <strong>développeur web full stack.</strong><br/>
